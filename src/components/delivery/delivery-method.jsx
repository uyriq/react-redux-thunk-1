...
export const DeliveryMethod = () => {
    ...
    const { deliveryMethods, deliveryMethodsRequest, selectedDeliveryId } = useSelector((state) => state.delivery)
        ...
        return deliveryMethodsRequest ? (
            ...
            <ul className={styles.options}>
                {deliveryMethods.map((item, index) => {
                    return <DeliveryMethodOption key={index} {...item} checked={item.id === selectedDeliveryId} />
                })}
            </ul>
        )
